...
namespace MyEMShop.Data.Context
{
    public class DatabaseContext : DbContext
    {
      ...
      .HasData(new { RP_Id = 1, RoleId = 1, PermissionId = 1 },
           ...
           .HasData(new { FaqId = 1, FaqGroupId = 1, FaqQuestion = "ثبت حساب کاربری به چه منظور صورت میگیرد؟", FaqAnswer = "ثبت حساب کاربری برای خرید و ثبت آدرس و موارد لازم برای ارسال سفارش صورت میگیرد" },
           new { FaqId = 2, FaqGroupId = 1, FaqQuestion = "چطور وضعیت سفارش خود را دنبال کنم؟", FaqAnswer = "از طریق پنل کاربری و قسمت فاکتور های من وضعیت سفارش قابل پیگیری است" },
           new { FaqId = 3, FaqGroupId = 1, FaqQuestion = "آیا میتوان محصولی که موجود نیست را سفارش داد؟ ", FaqAnswer = "بله. به این خاطر که محصولی که سفارش داده میشود ، بعد از ثبت سفارش وارد پروسه ی تولید میشود." },
           new { FaqId = 4, FaqGroupId = 2, FaqQuestion = "برای خرید از فروشگاه شما نیاز به اکانت دارم؟ ", FaqAnswer = "بله. برای خرید محصول از فروشگاه به دخت نیاز به ساخت اکانت کاربری است." },
           new { FaqId = 5, FaqGroupId = 2, FaqQuestion = "مزیت خرید از شما چیست؟ ", FaqAnswer = "جنس عالی ، دوخت عالی و حرفه ای " },
           new { FaqId = 6, FaqGroupId = 3, FaqQuestion = "چطور هزینه ی کالای خود را بپردازم؟ ", FaqAnswer = " هزینه ی کالای خریداری شده را به دو صورت میتوان پرداخت کرد : 1- از طریق شارژ کیف پول که در قسمت پنل کاربری و قسمت کیف پول قابل دسترسی است . 2- از طریق درگاه پرداخت مستقیم" },
           new { FaqId = 7, FaqGroupId = 3, FaqQuestion = "آیا مالیات هم به قیمت خرید افزوده میشود؟ ", FaqAnswer = "بله. مالیات بر ارزش افزوده هم به قیمت کالا اضافه و در قیمت نهایی محاسبه میشود." },
           new { FaqId = 8, FaqGroupId = 4, FaqQuestion = "چطور وضعیت سفارش خود را مشاهده کنم؟", FaqAnswer = "در قسمت پنل کاربری ، فاکتور های من قابل مشاهده است" },
           new { FaqId = 9, FaqGroupId = 4, FaqQuestion = "چطور و چه زمانی میتوانم سفارش خود را لغو کنم؟ ", FaqAnswer = "فقط تا 12 ساعت بعد از ثبت سفارش امکان لغو سفارش وجود دارد و در غیراین صورت لغو سفارش انجام نخواهد شد." },
           new { FaqId = 10, FaqGroupId = 5, FaqQuestion = "کالا چه زمانی به دست من میرسد؟ ", FaqAnswer = "زمانی که وضعیت سفارش به ارسال شده تغییر پیدا کند یعنی سفارش مشتری تحویل اداره ی پست شده است. و زمان رسیدن سفارش به دست مشتری بستگی به اداره ی پست دارد." },
           new { FaqId = 11, FaqGroupId = 5, FaqQuestion = "چرا کالا به موقع به من تحویل نشده؟ ", FaqAnswer = "بستگی به اداره ی پست دارد. " },
           new { FaqId = 12, FaqGroupId = 5, FaqQuestion = "نیاز به بازگشت یه کالا دارم، چطور باید اقدام کنم؟ ", FaqAnswer = "کالایی که خریداری شده ، قابل بازگشت نیست و فقط میتوان تا 12 ساعت بعد از ثبت فاکتور ،با هماهنگی با واحد پشتیبانی سایت به دخت آن را لغو کرد" });
            #endregion
