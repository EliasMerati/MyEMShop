    ...
    public class DatabaseContext : DbContext
    {
      ...
      .HasData(new { RP_Id = 1, RoleId = 1, PermissionId = 1 },
            ...
            modelBuilder.Entity<AboutUs>()
                .HasData(new { AboutUsId = 1, AboutUsText = "<p>در فروشگاه به دخت، ما معتقدیم که هر زنی شایسته لباسی زیبا و جذاب برای هر مناسبتی است. ما طیف گسترده ای از لباس های مجلسی زنانه را در طرح ها، رنگ ها و اندازه های مختلف ارائه می دهیم تا هر زنی بتواند لباسی را پیدا کند که به او احساس اعتماد به نفس و زیبایی بدهد.</p> <p>ما به کیفیت لباس های خود متعهد هستیم و فقط از مواد و ساخت با کیفیت بالا استفاده می کنیم. ما همچنین به خدمات مشتری خود متعهد هستیم و تیم ما همیشه آماده کمک به شما در یافتن لباس مناسب برای مناسبت خاص شما است.</p> <p>اگر به دنبال لباس مجلسی زنانه زیبا و با کیفیت هستید، فروشگاه به دخت مکان مناسبی برای شما است. ما طیف گسترده ای از گزینه ها را برای انتخاب دارید و تیم ما همیشه آماده کمک به شما است.</p> <p>در اینجا برخی از دلایلی که چرا باید از فروشگاه به دخت لباس مجلسی بخرید آورده شده است:</p> <ul> <li><strong>ما طیف گسترده ای از لباس های مجلسی زنانه را در طرح ها، رنگ ها و اندازه های مختلف ارائه می دهیم.</strong></li> <li><strong>ما به کیفیت لباس های خود متعهد هستیم و فقط از مواد و ساخت با کیفیت بالا استفاده می کنیم.</strong></li> <li><strong>ما به خدمات مشتری خود متعهد هستیم و تیم ما همیشه آماده کمک به شما در یافتن لباس مناسب برای مناسبت خاص شما است.</strong></li> </ul> <p>ما مشتاقیم تا شما را در فروشگاه خود ببینیم و به شما کمک کنیم تا لباس مجلسی رویایی خود را پیدا کنید.</p> <div class=\"simple-translate-system-theme\" id=\"simple-translate\"> <div> <div class=\"simple-translate-button isShow\" style=\"background-image: url(&quot;chrome-extension://cllnohpbfenopiakdcjmjcbaeapmkcdl/icons/512.png&quot;); height: 22px; width: 22px; top: 41px; left: 1135px;\">&nbsp;</div> <div class=\"simple-translate-panel \" style=\"width: 300px; height: 200px; top: 0px; left: 0px; font-size: 13px;\"> <div class=\"simple-translate-result-wrapper\" style=\"overflow: hidden;\"> <div class=\"simple-translate-move\" draggable=\"true\">&nbsp;</div> <div class=\"simple-translate-result-contents\"> <p class=\"simple-translate-result\" dir=\"auto\">&nbsp;</p> <p class=\"simple-translate-candidate\" dir=\"auto\">&nbsp;</p> </div> </div> </div> </div> </div>" });
            #endregion
